...
@section('content')
    ...
    <div class="page-heading header-text">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <h1>BIDANG PENGELOLAAN PERSAMPAHAN DAN PENGELOLAAN LIMBAH BERBAHAYA DAN BERACUN</h1>
              ...
              <div class="row">
                <div class="col-md-13">
                  ...
                  <div class="right-content">
                    <h2>BIDANG PENGELOLAAN PERSAMPAHAN DAN<em>&nbsp;PENGELOLAAN LIMBAH BERBAHAYA DAN BERACUN</em></h2>
